...
def get_wholesale_purchase_plan(wholesale_catalog: list[Barrel]):
    ...
    with db.engine.begin() as connection:
        ...
        for barrel in wholesale_catalog:
            if barrel.sku == "LARGE_RED_BARREL" and red_ml < 1000 and green_ml < 500 and blue_ml < 500 and dark_ml < 500 and barrel.price <= gold:
                order.append({
                "sku": "LARGE_RED_BARREL",
                "quantity": 1,
                })  
                gold -= barrel.price
            if barrel.sku == "LARGE_GREEN_BARREL" and red_ml >= green_ml and barrel.price <= gold:
                order.append({
            ...
            if barrel.sku == "LARGE_BLUE_BARREL" and red_ml >= blue_ml and green_ml >= blue_ml and barrel.price <= gold:
                order.append({
                "sku": "LARGE_BLUE_BARREL",
                "quantity": 1,
                })  
                gold -= barrel.price
            if barrel.sku == "LARGE_DARK_BARREL" and barrel.price <= gold:
                order.append({
